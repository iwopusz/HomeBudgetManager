                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <form>
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title" style="font-size: 20px">Edytuj wpływ</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control form-control-sm mt-2" placeholder="Nazwa wpływu" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-1 col-form-label">Źródło</label>
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control form-control-sm mt-2" placeholder="Źródło wpływu" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
